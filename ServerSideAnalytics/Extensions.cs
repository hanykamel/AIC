...
namespace ServerSideAnalytics
{
    public static class ServerSideExtensions
    {
        ...
        public static FluidAnalyticBuilder UseServerSideAnalytics(this IApplicationBuilder app, IAnalyticStore repository, IConfiguration configuration)
        {
            var builder = new FluidAnalyticBuilder(repository, configuration);
            app.Use(builder.Run);
            return builder;
        }
    }
