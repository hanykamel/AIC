...
@Component({
  selector: 'app-apply-internships',
  templateUrl: './apply-internships.component.html',
  styleUrls: ['./apply-internships.component.css', '../../careers/apply-careers/apply-careers.component.css'],
  providers: [FormatDatePipe]
})
export class ApplyInternshipsComponent implements OnInit {
  lang: string;
  body: any;
  data: any = {};
  survey: any;
  ...
  ngOnInit(): void {
    ...
    Serializer.addProperty("panel", "hidepanel:boolean");
    ...
    this._route.params.subscribe(res => {
      ...
      const date = res?.['date']
      this.internshipId = res?.['internshipId'] || "null";
      if (email && date && this.internshipId)
        this.getInternshipProfile(email, date, this.internshipId)
    })
    ...
    this.survey.onComplete.add(survey => {
      ...
      this._careersService.AddInternships(this.body).subscribe(data => {
        this.success = true;
        this._router.navigate['/careers-Opportunities/internships-list']
      }, error => {
  ...
  getInternshipProfile(email, date, internshipId) {
    this._careersService.GetInternshipProfile(email, date, internshipId).subscribe(data => {
      if (data) {
        this.data = data;
        this.internship = this.data.InternshipsViewModel;
        ...
        if (this.survey.getValue('LinkToPortfolio') == ("undefined") ||
  ...
  GenerateFormData(data) {
    ...
    this.formData.append('InternshipId', this.internshipId);
    this.formData.append('RefrenceNum', this.internship.ReferenceNumber);
